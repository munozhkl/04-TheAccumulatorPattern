...
def run_test_factorial():
    ...
    # ------------------------------------------------------------------
    # test3
    answer1 = math.factorial(3)
    answer2 = factorial(3)
    print('Test 3 expected:', answer1)
    print('Test 3 actual:', answer2)
    # test4
    answer1 = math.factorial(4)
    answer2 = factorial(4)
    print('Test 4 expected:', answer1)
    print('Test 4 actual:', answer2)
    # test5
    answer1 = math.factorial(6)
    answer2 = factorial(6)
    print('Test 5 expected:', answer1)
    print('Test 5 actual:', answer2)
...
def run_test_count_cosines_from():
    ...
    print('Test 5 e xpected:', expected)
    print('Test 5 actual:', answer)
    # test6
    expected = 2
    answer = count_cosines_from(4, 9, 0.7)
